...
describe("CoreSelectDialog", () => {
  ...
  it("renders core descriptions", () => {
    ...
    expect(screen.getByText("Fast, highly compatible. Best for most games.")).toBeTruthy();
    expect(screen.getByText("Cycle-accurate. Perfect accuracy, higher CPU usage.")).toBeTruthy();
  });
