...
const STYLES = {
  overlay: {
    container:
      "inline-flex items-center rounded-full bg-black/60 text-[10px] font-medium text-white/70 pointer-events-auto",
    branchButton:
      "inline-flex items-center gap-1.5 rounded-l-full py-0.5 pl-2.5 pr-2 transition-colors hover:bg-white/20 hover:text-white",
    worktreeButton:
      "inline-flex items-center gap-1 border-l border-white/20 rounded-r-full py-0.5 pl-1.5 pr-2.5 transition-colors hover:bg-white/20 hover:text-white",
    divider: "border-white/20",
  },
  titlebar: {
    container:
      "no-drag inline-flex items-center rounded-full border border-border/50 bg-muted/50 text-[10px] font-medium text-muted-foreground/70",
    branchButton:
      "inline-flex items-center gap-1.5 rounded-l-full py-0.5 pl-2.5 pr-2 transition-colors hover:bg-muted hover:text-muted-foreground",
    worktreeButton:
      "inline-flex items-center gap-1 border-l border-border/50 rounded-r-full py-0.5 pl-1.5 pr-2.5 transition-colors hover:bg-muted hover:text-muted-foreground",
