...
const CRTPowerOn: React.FC<{ duration: number; onComplete: () => void }> = ({
  ...
  useEffect(() => {
    ...
    const staticTimer = setTimeout(
      () => setPhase("fade"),
      timings.line + timings.expand + timings.static,
    );
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 20px 5px rgba(255, 255, 255, 0.8), 0 0 40px 10px rgba(100, 200, 255, 0.5)",
            }}
          />
        </div>
      )}
...
const CRTPowerOff: React.FC<{ duration: number; onComplete: () => void }> = ({
  ...
  useEffect(() => {
    ...
    const blackTimer = setTimeout(
      () => setPhase("black"),
      timings.shrink + timings.line + timings.dot,
    );
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 15px 4px rgba(255, 255, 255, 0.7), 0 0 30px 8px rgba(100, 200, 255, 0.4)",
            }}
          />
        </div>
      )}
      ...
      {phase === "dot" && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            ...
            style={{
              animation: `crt-dot-fade ${duration * 0.2}ms ease-out forwards`,
              boxShadow:
                "0 0 20px 10px rgba(255, 255, 255, 0.6), 0 0 40px 20px rgba(100, 200, 255, 0.3)",
              height: 6,
              width: 6,
            }}
          />
